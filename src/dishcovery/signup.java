...
if (!em.contains("@") || !em.contains(".")) {
    javax.swing.JOptionPane.showMessageDialog(null, "Please enter a valid email");
    return;
}
if (un.isEmpty()) {
    javax.swing.JOptionPane.showMessageDialog(null, "Please fill out username");
    return;
}
if (pass.isEmpty()) {
...
if (pass.length() < 8) {
    javax.swing.JOptionPane.showMessageDialog(null, "Password must be at least 8 characters");
    return;
}
